...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/24GqsTnYk1)
...
```sh
npx nx serve probi-exam
```

To create a production bundle:

```sh
npx nx build probi-exam
```

To see all available targets to run for a project, run:

```sh
npx nx show project probi-exam
```
